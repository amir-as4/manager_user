                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="socials">
                        ...
                        <div class="footer-social">
                            <a href="#" target="_blank"><i class="fab fa-instagram"></i>اینستاگرام تاپ کالا</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="info">
            <div class="row">
                ...
                <div class="col-12 col-lg-4 text-center">
                    <a href="#" target="_blank"><img src="{{ asset('images/bazzar.png') }}" width="159" height="48"
                                                     alt=""></a>
                    <a href="#" target="_blank"><img src="{{ asset('images/sibapp.png') }}" width="159" height="48"
                                                     alt=""></a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="symbol col-12 col-lg-5">
                    <a href="#" target="_blank"><img src="{{ asset('images/symbol-01.png') }}" alt=""></a>
                    <a href="#" target="_blank"><img src="{{ asset('images/symbol-02.png') }}" alt=""></a>
                </div>
                <div class="col-12">
                    <div class="row">
                        <ul class="footer-partners default">
                            <li class="col-md-3 col-sm-6">
                                <a href=""><img src="{{ asset('images/footer/1.svg') }}" alt=""></a>
                            </li>
                            <li class="col-md-3 col-sm-6">
                                <a href=""><img src="{{ asset('images/footer/2.svg') }}" alt=""></a>
                            </li>
                            <li class="col-md-3 col-sm-6">
                                <a href=""><img src="{{ asset('images/footer/3.svg') }}" alt=""></a>
                            </li>
                            <li class="col-md-3 col-sm-6">
                                <a href=""><img src="{{ asset('images/footer/4.svg') }}" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
