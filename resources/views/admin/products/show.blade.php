        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control" type="text" value="{{ verta($product->created_at)->format("%B %d %Y") }}" disabled>
                </div>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text"
                                               value="{{ $variation->date_on_sale_from == null ? null : verta($variation->date_on_sale_from)->format("%B %d %Y") }}"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text"
                                               value="{{ $variation->date_on_sale_to == null ? null : verta($variation->date_on_sale_to)->format("%B %d %Y") }}"
                                               disabled class="form-control">
                                    </div>
                                </div>
                            </div>
